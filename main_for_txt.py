...
btn_delete_all = QPushButton('Удалить все заметки')
...
h_5_2_line.addWidget(btn_delete_all)
...
right_side.addLayout(h_5_2_line)
...
btn_delete_all.clicked.connect(del_all)
