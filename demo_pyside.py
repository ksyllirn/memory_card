...
from PySide6.QtWidgets import (
    QApplication, QHBoxLayout, QVBoxLayout, QLabel, QPushButton, QInputDialog,
    QTextEdit, QLineEdit, QWidget, QListWidget
)
...
window.setWindowIcon(QtGui.QIcon('3.png'))
...
btn_del_all = QPushButton('Удалить всё')
...
h_4_1_line.addWidget(btn_del_all)
...
right_side.addLayout(h_4_1_line)
...
btn_del_all.clicked.connect(del_all)
